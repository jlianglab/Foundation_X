...
def build(image_set, args):
    ...
    PATHS = {
        ...
        "chestxdet_train": ('/scratch/jliang12/data/ChestX-Det/train', '/scratch/jliang12/FoundationX_localization_bbox_annotation_collections/ChestX-Det_Disease/ChestX_det_train_NAD_v2.json'),
        ...
        "chestxdet_test": ('/scratch/jliang12/data/ChestX-Det/test', '/scratch/jliang12/FoundationX_localization_bbox_annotation_collections/ChestX-Det_Disease/ChestX_det_test_NAD_v2.json'),
        ...
        "vindrcxr_train": (root / "train_jpeg", root / "annotations/VinDrCXR_Kaggle_14Diseases_TRAIN.json"), ## From Shiv
        "vindrcxr_test": (root / "test_jpeg", root / "annotations/VinDrCXR_Kaggle_14Diseases_TEST.json"), ## From Shiv
        ...
        "node21_noduleDataset_train": ('/scratch/jliang12/data/NODE21/png_images', '/scratch/jliang12/FoundationX_localization_bbox_annotation_collections/NODE21/Node21_Nodule_Bbox_Ann_train_2.json'),
        ...
        "node21_noduleDataset_test": ('/scratch/jliang12/data/NODE21/png_images/', '/scratch/jliang12/FoundationX_localization_bbox_annotation_collections/NODE21/Node21_Nodule_Bbox_Ann_test_2.json'),

        "tbx11k_catagnostic_train": ('/scratch/jliang12/data/tbx11k/TBX11K/imgs', '/scratch/jliang12/data/tbx11k/TBX11K/annotations/all_train_2.json'),
        "tbx11k_catagnostic_train_A": ('/scratch/jliang12/data/tbx11k/TBX11K/imgs', '/scratch/jliang12/data/tbx11k/TBX11K/annotations/TBX11K_train_A.json'),
        "tbx11k_catagnostic_train_B": ('/scratch/jliang12/data/tbx11k/TBX11K/imgs', '/scratch/jliang12/data/tbx11k/TBX11K/annotations/TBX11K_train_B.json'),
        "tbx11k_catagnostic_test": ('/scratch/jliang12/data/tbx11k/TBX11K/imgs', '/scratch/jliang12/data/tbx11k/TBX11K/annotations/all_val_2.json'),
        ...
        "candidptx_pneumothorax_train_full":("/scratch/jliang12/data/CANDID-PTX/png", "/scratch/nuislam/Model_Checkpoints/localization_bbox_annotation_collections/CANDID_PTX/CANDID_PTX_train_1.json"),
        "candidptx_pneumothorax_train_A":("/scratch/jliang12/data/CANDID-PTX/png", "/scratch/nuislam/Model_Checkpoints/localization_bbox_annotation_collections/CANDID_PTX/CANDID_PTX_train_1_1.json"),
        "candidptx_pneumothorax_train_B":("/scratch/jliang12/data/CANDID-PTX/png", "/scratch/nuislam/Model_Checkpoints/localization_bbox_annotation_collections/CANDID_PTX/CANDID_PTX_train_1_2.json"),
        "candidptx_pneumothorax_val":("/scratch/jliang12/data/CANDID-PTX/png", "/scratch/nuislam/Model_Checkpoints/localization_bbox_annotation_collections/CANDID_PTX/CANDID_PTX_valid_1.json"),
        "candidptx_pneumothorax_test": ("/scratch/jliang12/data/CANDID-PTX/png", "/scratch/nuislam/Model_Checkpoints/localization_bbox_annotation_collections/CANDID_PTX/CANDID_PTX_test_1.json"),

        "rsnaPneumoniaDetection_Train": ('/scratch/jliang12/data/rsna-pneumonia-detection-challenge/stage_2_train_images_png', '/scratch/jliang12/FoundationX_localization_bbox_annotation_collections/RSNA_Pneumonia_Detection_Challenge/rsnaPneumoniaDetection_Train.json'), # rsnaPneumoniaDetection_Train
        ...
        "rsnaPneumoniaDetection_Valid": ('/scratch/jliang12/data/rsna-pneumonia-detection-challenge/stage_2_train_images_png', '/scratch/jliang12/FoundationX_localization_bbox_annotation_collections/RSNA_Pneumonia_Detection_Challenge/rsnaPneumoniaDetection_Valid.json'),
        "rsnaPneumoniaDetection_Test": ('/scratch/jliang12/data/rsna-pneumonia-detection-challenge/stage_2_train_images_png', '/scratch/jliang12/FoundationX_localization_bbox_annotation_collections/RSNA_Pneumonia_Detection_Challenge/rsnaPneumoniaDetection_Test.json'),
        ...
        "nihLOC_test" : ("/data/jliang12/shared/dataset/NIH_Localization/bbox_img" , "/data/jliang12/shared/dataset/NIH_Localization/nih_bbox_coco_1024_fromTensorcsv.json"), # nih_bbox_coco_1024_basedOnChestX-Det nih_bbox_coco_1024_fromTensorcsv
    }
