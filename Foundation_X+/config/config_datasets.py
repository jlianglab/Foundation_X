DATASETS_CONFIG = {
    ...
    "loc_nih_testList": "/data/jliang12/shared/dataset/NIH_Localization/nih_bbox_coco_1024_basedOnChestX-Det.json",
    "loc_nih_test2List": "/data/jliang12/shared/dataset/NIH_Localization/nih_bbox_coco_from_tfcsv_native_labels.json",
    ...
    "loc_node21_trainList": "/scratch/jliang12/FoundationX_localization_bbox_annotation_collections/NODE21/Node21_Nodule_Bbox_NAD_train_3.json",
    "loc_node21_testList": "/scratch/jliang12/FoundationX_localization_bbox_annotation_collections/NODE21/Node21_Nodule_Bbox_NAD_test_3.json",
    ...
    "loc_siimacr_trainList": "/scratch/jliang12/FoundationX_localization_bbox_annotation_collections/SIIM-ACR_Pneumothorax/siim_pneumothorax_train_coco.json",
    "loc_siimacr_valList": "/scratch/jliang12/FoundationX_localization_bbox_annotation_collections/SIIM-ACR_Pneumothorax/siim_pneumothorax_val_coco.json",
    "loc_siimacr_testList": "/scratch/jliang12/FoundationX_localization_bbox_annotation_collections/SIIM-ACR_Pneumothorax/siim_pneumothorax_test_coco.json",
    ...
    "loc_candidptx_trainList": "/scratch/jliang12/FoundationX_localization_bbox_annotation_collections/CANDID_PTX/CANDID_PTX_train_1.json",
    "loc_candidptx_valList": "/scratch/jliang12/FoundationX_localization_bbox_annotation_collections/CANDID_PTX/CANDID_PTX_valid_1.json",
    "loc_candidptx_testList": "/scratch/jliang12/FoundationX_localization_bbox_annotation_collections/CANDID_PTX/CANDID_PTX_test_1.json",
