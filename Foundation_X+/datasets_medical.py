...
class ChestXDet_cls(Dataset): ## For Classification
  def __init__(self, images_path, file_path, augment, num_class=13, anno_percent=100): ## ChestX_det_train_NAD_v2  ChestX_det_test_NAD_v2
    ...
    gt_file = os.path.join("/scratch/jliang12/data/ChestX-Det", f"ChestX_det_{split}_NAD_v2.json")
...
############## ===========  Cls - Loc - Seg DataLoader ============ ################################## -- NAD's code for Dataloader
    ...
    if args.taskcomponent in ['foundation_x3_FineTuning', 'foundation_x4_pretraining'] and args.cyclictask == 'segFT_TESTseg_siimacrSEG':  
        ...
        dataset_test = SIIMPneumothorax_test_original(images_path = "/data/jliang12/jpang12/dataset/Pneumothorax_segmentation/stage_2_images/", image_file="stage_2_sample_submission.csv" , image_size=(224,224))
    ...
    if args.taskcomponent in ['foundation_x3_FineTuning'] and args.cyclictask == 'clsFT_TESTcls_chexpertCLS':
        ...
        if args.serverC == 'DFS':
            ...
            data_dir = "/data/jliang12/jpang12/dataset/CheXpert-v1.0/"
        elif args.serverC == "SOL":
            # data_dir = "/data/jliang12/mhossei2/Dataset/" ## CheXpert-v1.0
            data_dir = "/scratch/jliang12/data/"
