...
LOGFILE=/scratch/nuislam/Model_Checkpoints/IntegratedModel_DINOpipeline/Integrated_Model_vindrcxr_OrganSeg_/run105_Nahid_VinDrCXR_HLLRL_LocSeg_FuF_m0.80_noLayerNorm_yesFeatureNorm_noL2Reg_SGD_TrStg1
...
# RESUME=/scratch/nuislam/Model_Checkpoints/IntegratedModel_DINOpipeline/Integrated_Model_vindrcxr_OrganSeg_/run104_Nahid_VinDrCXR_HLLRL_LocSeg_FuF_m0.80_noLayerNorm_yesFeatureNorm_noL2Reg/ckpt_E129_TH8.pth
