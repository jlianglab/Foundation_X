...
class DeformableTransformer(nn.Module):
    ...
    def __init__(self, d_model=256, nhead=8, 
        ...
        decoder_.append( copy.deepcopy(decoder_temp) ) # 7
        ...
        if two_stage_type =='standard':
            ...
            enc_output_norm_temp.append( copy.deepcopy(nn.LayerNorm(d_model)) )
            enc_output_temp.append( copy.deepcopy(nn.Linear(d_model, d_model)) ) # 7
            enc_output_norm_temp.append( copy.deepcopy(nn.LayerNorm(d_model)) )
        ...
        enc_outputMem_LinearProjection.append( nn.Linear(d_model, d_model) ) # 7
        ...
        if rm_self_attn_layers is not None:
            ...
            for lid, dec_layer in enumerate(self.decoder[5].layers): # 6
                if lid in rm_self_attn_layers:
                    dec_layer.rm_self_attn_modules()
            for lid, dec_layer in enumerate(self.decoder[5].layers): # 7
                if lid in rm_self_attn_layers:
                    dec_layer.rm_self_attn_modules()
        ...
        self.decoder[5].rm_detach = rm_detach # 7
