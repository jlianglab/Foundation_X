...
def make_coco_transforms(image_set, fix_size=False, strong_aug=False, args=None):
    ...
    if image_set == 'chestxdet_train' or image_set == 'vindrcxr_train' or image_set == "vindrcxrOrgan_train":
        return T.Compose([
            ...
            T.ResizeDebug((max(scales), max(scales))),
            normalize,
        ])
    ...
    if image_set in ['val', 'eval_debug', 'train_reg', 'test', 'chestxdet_test', 'vindrcxr_test', 'vindrcxrOrgan_test', 'vindrcxrOrgan_testHeart', 'vindrcxrOrgan_testLung', 'vindrcxrOrgan_testLeftLung', 'vindrcxrOrgan_testRightLung', 'node21_noduleDataset_test', 'tbx11k_catagnostic_test', 'objects365_NAD_test', 'objects365_NAD_val', 'candidptx_pneumothorax_val', 'candidptx_pneumothorax_test', 'rsnaPneumoniaDetection_Valid', 'rsnaPneumoniaDetection_Test', 'siimacr_val', 'siimacr_test']:
        ...
        return T.Compose([
            # T.RandomResize([max(scales)], max_size=max_size),
            T.ResizeDebug((max(scales), max(scales))), # 480x480
            # T.ResizeDebug([max(scales)], max_size=max_size),
            normalize,
        ])
...
def build(image_set, args):
    ...
    PATHS = {
        ...
        "chestxdet_train": ('/scratch/jliang12/data/ChestX-Det/ChestX-Det/train', '/scratch/jliang12/FoundationX_localization_bbox_annotation_collections/ChestX-Det_Disease/ChestX_det_train_NAD_v2.json'),
        "chestxdet_train_A": ('/scratch/jliang12/data/ChestX-Det/ChestX-Det/train', '/scratch/jliang12/FoundationX_localization_bbox_annotation_collections/ChestX-Det_Disease/ChestX_det_train_A.json'),
        "chestxdet_train_B": ('/scratch/jliang12/data/ChestX-Det/ChestX-Det/train', '/scratch/jliang12/FoundationX_localization_bbox_annotation_collections/ChestX-Det_Disease/ChestX_det_train_B.json'),
        "chestxdet_test": ('/scratch/jliang12/data/ChestX-Det/ChestX-Det/test', '/scratch/jliang12/FoundationX_localization_bbox_annotation_collections/ChestX-Det_Disease/ChestX_det_test_NAD_v2.json'),

        "vindrcxr_train": (root / "train_jpeg", "data/vindrcxr_detection/VinDrCXR_Kaggle_14Diseases_TRAIN_modified_wbf.json"), # annotations_train_coco.json | VinDrCXR_Kaggle_14Diseases_TRAIN.json
        "vindrcxr_test": (root / "test_jpeg", "data/vindrcxr_detection/VinDrCXR_Kaggle_14Diseases_TEST_modified_wbf.json"), # annotations_test_coco.json | VinDrCXR_Kaggle_14Diseases_TEST.json
        ...
        "node21_noduleDataset_train": ('/scratch/jliang12/data/NODE21/cxr_images/proccessed_data/images_png', '/scratch/jliang12/FoundationX_localization_bbox_annotation_collections/NODE21/Node21_Nodule_Bbox_Ann_train_2.json'),
        "node21_noduleDataset_train_A": ('/scratch/jliang12/data/NODE21/cxr_images/proccessed_data/images_png', '/scratch/jliang12/FoundationX_localization_bbox_annotation_collections/NODE21/NODE21_train_A.json'),
        "node21_noduleDataset_train_B": ('/scratch/jliang12/data/NODE21/cxr_images/proccessed_data/images_png', '/scratch/jliang12/FoundationX_localization_bbox_annotation_collections/NODE21/NODE21_train_B.json'),
        "node21_noduleDataset_test": ('/scratch/jliang12/data/NODE21/cxr_images/proccessed_data/images_png/', '/scratch/jliang12/FoundationX_localization_bbox_annotation_collections/NODE21/Node21_Nodule_Bbox_Ann_test_2.json'),

        "tbx11k_catagnostic_train": ('/scratch/jliang12/data/tbx11k/imgs', '/scratch/jliang12/data/tbx11k/annotations/all_train_2.json'),
        "tbx11k_catagnostic_train_A": ('/scratch/jliang12/data/tbx11k/imgs', '/scratch/jliang12/data/tbx11k/annotations/TBX11K_train_A.json'),
        "tbx11k_catagnostic_train_B": ('/scratch/jliang12/data/tbx11k/imgs', '/scratch/jliang12/data/tbx11k/annotations/TBX11K_train_B.json'),
        "tbx11k_catagnostic_test": ('/scratch/jliang12/data/tbx11k/imgs', '/scratch/jliang12/data/tbx11k/annotations/all_val_2.json'),
        ...
        "candidptx_pneumothorax_train_full":("/scratch/jliang12/data/CANDID-PTX/images_png_jp", "/scratch/nuislam/Model_Checkpoints/localization_bbox_annotation_collections/CANDID_PTX/CANDID_PTX_train_1.json"),
        "candidptx_pneumothorax_train_A":("/scratch/jliang12/data/CANDID-PTX/images_png_jp", "/scratch/nuislam/Model_Checkpoints/localization_bbox_annotation_collections/CANDID_PTX/CANDID_PTX_train_1_1.json"),
        "candidptx_pneumothorax_train_B":("/scratch/jliang12/data/CANDID-PTX/images_png_jp", "/scratch/nuislam/Model_Checkpoints/localization_bbox_annotation_collections/CANDID_PTX/CANDID_PTX_train_1_2.json"),
        "candidptx_pneumothorax_val":("/scratch/jliang12/data/CANDID-PTX/images_png_jp", "/scratch/nuislam/Model_Checkpoints/localization_bbox_annotation_collections/CANDID_PTX/CANDID_PTX_valid_1.json"),
        "candidptx_pneumothorax_test": ("/scratch/jliang12/data/CANDID-PTX/images_png_jp", "/scratch/nuislam/Model_Checkpoints/localization_bbox_annotation_collections/CANDID_PTX/CANDID_PTX_test_1.json"),

        "rsnaPneumoniaDetection_Train": ('/scratch/jliang12/data/rsna-pneumonia-detection-challenge/stage_2_train_images_png', '/scratch/jliang12/data/rsna-pneumonia-detection-challenge/bbox_annotations/rsnaPneumoniaDetection_Train.json'), # rsnaPneumoniaDetection_Train
        "rsnaPneumoniaDetection_Train_A": ('/scratch/jliang12/data/rsna-pneumonia-detection-challenge/stage_2_train_images_png', '/scratch/jliang12/data/rsna-pneumonia-detection-challenge/bbox_annotations/rsnaPneumoniaDetection_train_A.json'),
        "rsnaPneumoniaDetection_Train_B": ('/scratch/jliang12/data/rsna-pneumonia-detection-challenge/stage_2_train_images_png', '/scratch/jliang12/data/rsna-pneumonia-detection-challenge/bbox_annotations/rsnaPneumoniaDetection_train_B.json'),
        "rsnaPneumoniaDetection_Valid": ('/scratch/jliang12/data/rsna-pneumonia-detection-challenge/stage_2_train_images_png', '/scratch/jliang12/data/rsna-pneumonia-detection-challenge/bbox_annotations/rsnaPneumoniaDetection_Valid.json'),
        "rsnaPneumoniaDetection_Test": ('/scratch/jliang12/data/rsna-pneumonia-detection-challenge/stage_2_train_images_png', '/scratch/jliang12/data/rsna-pneumonia-detection-challenge/bbox_annotations/rsnaPneumoniaDetection_Test.json'),

        "siimacr_train": ('/scratch/jliang12/data/siim_pneumothorax_segmentation/train_jpeg', '/scratch/nuislam/Model_Checkpoints/localization_bbox_annotation_collections/SIIM-ACR_Pneumothorax/siim_pneumothorax_train_coco.json'),
        "siimacr_train_A": ('/scratch/jliang12/data/siim_pneumothorax_segmentation/train_jpeg', '/scratch/nuislam/Model_Checkpoints/localization_bbox_annotation_collections/SIIM-ACR_Pneumothorax/siim_pneumothorax_train_coco_A.json'),
        "siimacr_train_B": ('/scratch/jliang12/data/siim_pneumothorax_segmentation/train_jpeg', '/scratch/nuislam/Model_Checkpoints/localization_bbox_annotation_collections/SIIM-ACR_Pneumothorax/siim_pneumothorax_train_coco_B.json'),
        "siimacr_val": ('/scratch/jliang12/data/siim_pneumothorax_segmentation/val_jpeg', '/scratch/nuislam/Model_Checkpoints/localization_bbox_annotation_collections/SIIM-ACR_Pneumothorax/siim_pneumothorax_val_coco.json'),
        "siimacr_test": ('/scratch/jliang12/data/siim_pneumothorax_segmentation/test_jpeg', '/scratch/nuislam/Model_Checkpoints/localization_bbox_annotation_collections/SIIM-ACR_Pneumothorax/siim_pneumothorax_test_coco.json'),


        # "objects365_NAD_train": ('/scratch/jliang12/data/objects365/train', '/scratch/jliang12/data/objects365/train/zhiyuan_objv2_train_fix.json'),
        # "objects365_NAD_val": ('/scratch/jliang12/data/objects365/val', '/scratch/jliang12/data/objects365/val/sample_2020.json'),
        # "objects365_NAD_test": ('/scratch/jliang12/data/objects365/test', '/scratch/jliang12/data/objects365/test/zhiyuan_objv2_test_fix_cleaned_pruned.json'),
        "objects365_NAD_train": ('/scratch/jliang12/data/objects365/train', '/scratch/nralbert/research/data/o365/train/zhiyuan_objv2_train_fix.json'),
        "objects365_NAD_val": ('/scratch/jliang12/data/objects365/val', '/scratch/jliang12/data/objects365/val/sample_2020.json'),
        "objects365_NAD_test": ('/scratch/jliang12/data/objects365/test', '/scratch/nralbert/research/data/o365/test/zhiyuan_objv2_test_fix_cleaned_pruned.json'),
    }
    ...
    elif image_set in ["objects365_NAD_train", "objects365_NAD_test", "objects365_NAD_val", "node21_nodule_dataset_all", "node21_noduleDataset_train", "node21_noduleDataset_test", "tbx11k_catagnostic_train", "tbx11k_catagnostic_test", "candidptx_pneumothorax_val", "candidptx_pneumothorax_test", "rsnaPneumoniaDetection_Valid", "rsnaPneumoniaDetection_Test", "siimacr_test", "siimacr_val"]:
        dataset = CocoDetection(img_folder, ann_file, 
                transforms=make_coco_transforms(image_set, fix_size=False, strong_aug=False, args=args), 
                return_masks=False,
                aux_target_hacks=None,
