...
def main(args):
    ...
    if args.taskcomponent in ["foundation_x_pretraining", "foundation_x2_pretraining"]: # Binary Class
        args.num_classes = 14
        args.dn_labelbook_size = 15
    if args.taskcomponent in ["foundation_x3_pretraining"]: # Binary Class
        args.num_classes = 14
        args.dn_labelbook_size = 15
    ...
    if args.taskcomponent in ["foundation_x_pretraining", "foundation_x2_pretraining", "foundation_x3_pretraining"]:
        loss_scaler = NativeScaler()
        param_dicts = get_param_dict(args, model_without_ddp)
        if args.opt == "adamw":
            optimizer = torch.optim.AdamW([
