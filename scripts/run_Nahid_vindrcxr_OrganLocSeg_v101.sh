...
LOGFILE=/scratch/nuislam/Model_Checkpoints/IntegratedModel_DINOpipeline/Integrated_Model_vindrcxr_OrganSeg_/run104_Nahid_VinDrCXR_HLLRLSegmentation_FuF_m0.50to1_noLayerNorm_yesFeatureNorm_noL2Reg_MSEloss100x
...
# RESUME=/scratch/nuislam/Model_Checkpoints/IntegratedModel_DINOpipeline/Integrated_Model_vindrcxr_OrganSeg_/run104_Nahid_VinDrCXR_HLLRLSegmentation_FuF_m0.80_noLayerNorm_yesFeatureNorm_noL2Reg/ckpt_E239_TH10.pth
