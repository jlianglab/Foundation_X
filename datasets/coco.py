...
def build(image_set, args):
    ...
    PATHS = {
        ...
        "chestxdet_train": ('/scratch/jliang12/data/ChestX-Det/train', '/scratch/jliang12/data/ChestX-Det/ChestX_det_train_NAD_v2.json'),
        "chestxdet_train_A": ('/scratch/jliang12/data/ChestX-Det/train', '/scratch/jliang12/data/ChestX-Det/ChestX_det_train_A.json'),
        "chestxdet_train_B": ('/scratch/jliang12/data/ChestX-Det/train', '/scratch/jliang12/data/ChestX-Det/ChestX_det_train_B.json'),
        "chestxdet_test": ('/scratch/jliang12/data/ChestX-Det/test', '/scratch/jliang12/data/ChestX-Det/ChestX_det_test_NAD_v2.json'),
        ...
        "node21_noduleDataset_train": ('/scratch/jliang12/data/NODE21/cxr_images/proccessed_data/images_png', '/scratch/jliang12/data/NODE21/cxr_images/proccessed_data/Node21_Nodule_Bbox_Ann_train_2.json'),
        "node21_noduleDataset_train_A": ('/scratch/jliang12/data/NODE21/cxr_images/proccessed_data/images_png', '/scratch/jliang12/data/NODE21/cxr_images/proccessed_data/NODE21_train_A.json'),
        "node21_noduleDataset_train_B": ('/scratch/jliang12/data/NODE21/cxr_images/proccessed_data/images_png', '/scratch/jliang12/data/NODE21/cxr_images/proccessed_data/NODE21_train_B.json'),
        "node21_noduleDataset_test": ('/scratch/jliang12/data/NODE21/cxr_images/proccessed_data/images_png/', '/scratch/jliang12/data/NODE21/cxr_images/proccessed_data/Node21_Nodule_Bbox_Ann_test_2.json'),

        "tbx11k_catagnostic_train": ('/scratch/jliang12/data/tbx11k/tbx11k/TBX11K/imgs', '/scratch/jliang12/data/tbx11k/tbx11k/TBX11K/annotations/all_train_2.json'),
        "tbx11k_catagnostic_train_A": ('/scratch/jliang12/data/tbx11k/tbx11k/TBX11K/imgs', '/scratch/jliang12/data/tbx11k/tbx11k/TBX11K/annotations/TBX11K_train_A.json'),
        "tbx11k_catagnostic_train_B": ('/scratch/jliang12/data/tbx11k/tbx11k/TBX11K/imgs', '/scratch/jliang12/data/tbx11k/tbx11k/TBX11K/annotations/TBX11K_train_B.json'),
        "tbx11k_catagnostic_test": ('/scratch/jliang12/data/tbx11k/tbx11k/TBX11K/imgs', '/scratch/jliang12/data/tbx11k/tbx11k/TBX11K/annotations/all_val_2.json'),
